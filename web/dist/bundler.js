    ...
    _createClass(AppComponent, [{
        ...
        value: function render() {
            return _react2.default.createElement(
                'div',
                { className: 'appmain' },
                this.state.nameText ? _react2.default.createElement(_popBox2.default, { text: this.state.nameText }) : '',
                ...
                _react2.default.createElement(
                    'div',
                    { className: 'inputBox' },
                    _react2.default.createElement('input', { type: 'text', className: 'form-control input-name', placeholder: '\u8BF7\u8F93\u5165\u4F60\u7684\u6635\u79F0\uFF01', ref: 'name' }),
                    _react2.default.createElement(
                        'button',
                        { type: 'submit', className: 'btn btn-default', onClick: this.sendName.bind(this) },
                        '\u767B\u5F55'
                    ),
                    _react2.default.createElement(
                        'button',
                        { type: 'submit', className: 'btn btn-default', onClick: this.quit.bind(this) },
                        '\u9000\u51FA'
                    )
                ),
                _react2.default.createElement('textarea', { className: 'form-control', rows: '3', ref: 'msg' }),
                _react2.default.createElement(
                    'button',
                    { type: 'submit', className: 'btn btn-default', onClick: this.sendMsg.bind(this) },
                    'send'
                ),
                this.props.children
            );
