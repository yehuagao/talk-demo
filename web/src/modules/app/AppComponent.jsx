    ...
    render() {
        return (
        	   <div className="appmain">
                    {this.state.nameText != this.state.currenName ? <Popbox text={this.state.nameText}/> : ''}
                    ...
                    <div className="inputBox">
                        ...
                        <button type="submit" className="btn btn-default" ref="quitBtn" onClick={this.quit.bind(this)} disabled>退出</button>
                    </div>
